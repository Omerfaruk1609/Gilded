      ...
      <Container maxWidth="lg" sx={{ zIndex: 2, position: 'relative' }}>
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, alignItems: 'center', gap: 6 }}>
          <Box sx={{ flex: 1, textAlign: { xs: 'center', md: 'left' } }}>
            ...
            <Typography variant="h5" sx={{ color: 'rgba(255, 255, 255, 0.8)', fontWeight: 300, maxWidth: '500px' }}>
              Topluluğumuza katıl ve kırıklarını sanat eserine dönüştürmeye başla.
            </Typography>
          </Box>
          ...
          >
            <Typography variant="h5" sx={{ mb: 3, fontWeight: 700, color: '#fff', textAlign: 'center' }}>
              Yeni Hesap Oluştur
            </Typography>
            ...
            <TextField 
              ...
              sx={{ '& .MuiOutlinedInput-root': { color: '#fff', '& fieldset': { borderColor: 'rgba(255,255,255,0.2)' } }, '& .MuiInputLabel-root': { color: 'rgba(255,255,255,0.5)' } }}
            />
            <TextField 
            ...
            <Button 
              ...
              sx={{ mt: 3, mb: 2, py: 1.5, bgcolor: '#D4AF37', color: '#000', fontWeight: 800, '&:hover': { bgcolor: '#F9E076' } }}
            >
              {loading ? <CircularProgress size={24} color="inherit" /> : 'Kayıt Ol'}
            </Button>

            <Divider sx={{ my: 3, '&::before, &::after': { borderColor: 'rgba(255,255,255,0.1)' } }}>
              <Typography sx={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.8rem' }}>ZATEN HESABIN VAR MI?</Typography>
            </Divider>

            <Button 
              fullWidth variant="outlined" onClick={() => navigate('/login')}
              sx={{ color: '#D4AF37', borderColor: 'rgba(212, 175, 55, 0.3)', fontWeight: 600, '&:hover': { borderColor: '#D4AF37', bgcolor: 'rgba(212, 175, 55, 0.05)' } }}
            >
              Giriş Yap
            </Button>
          </Paper>
